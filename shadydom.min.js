...
0,d=this.childNodes,c;c=d[b];b++)c.nodeType!==Node.COMMENT_NODE&&a.push(c.textContent);return a.join("")}return H.textContent(this)},set:function(a){if(this.nodeType===Node.ELEMENT_NODE||this.nodeType===Node.DOCUMENT_FRAGMENT_NODE){for(;this.firstChild;)this.removeChild(this.firstChild);(this.nodeType===Node.ELEMENT_NODE||0<a.length)&&this.appendChild(document.createTextNode(a))}else this.nodeValue=a},configurable:!0},firstElementChild:{get:function(){if(this.__shady&&void 0!==this.__shady.firstChild){for(var a=
